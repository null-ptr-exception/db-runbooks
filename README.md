...
| `MARIADB_OPERATOR_CHART_VERSION` | latest | Helm chart version | Pin mariadb-operator and CRD chart versions for compatibility testing |
...
| `restart` | `:30081` (MariaDB) | Operator-driven restart by patching the MariaDB CR Pod annotation | `namespace`, optional `allow_role_change`, `dry_run`, `confirm`, `annotation_key`, `metadata_field` | [docs/mariadb/restart.md](docs/mariadb/restart.md) |
