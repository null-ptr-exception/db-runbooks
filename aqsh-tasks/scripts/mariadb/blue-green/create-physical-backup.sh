...
bg_validate_dns_label "namespace" "$BG_NAMESPACE" "blue-green/create-physical-backup"
bg_validate_dns_label "mariadb" "$BG_MDB" "blue-green/create-physical-backup"
bg_validate_dns_label "backup_name" "$BACKUP_NAME" "blue-green/create-physical-backup"
bg_validate_s3_bucket "backup_bucket" "$BACKUP_BUCKET" "blue-green/create-physical-backup"
bg_validate_s3_prefix "backup_prefix" "$BACKUP_PREFIX" "blue-green/create-physical-backup"
bg_validate_endpoint "backup_endpoint" "$BACKUP_ENDPOINT" "blue-green/create-physical-backup"
bg_validate_region "backup_region" "$BACKUP_REGION" "blue-green/create-physical-backup"
bg_validate_dns_label "backup_access_secret" "$BACKUP_ACCESS_SECRET" "blue-green/create-physical-backup"
bg_validate_secret_key "backup_access_key" "$BACKUP_ACCESS_KEY" "blue-green/create-physical-backup"
bg_validate_secret_key "backup_secret_key" "$BACKUP_SECRET_KEY" "blue-green/create-physical-backup"
bg_validate_enum "backup_target" "$BACKUP_TARGET" "blue-green/create-physical-backup" Primary Replica PreferReplica
bg_validate_enum "backup_compression" "$BACKUP_COMPRESSION" "blue-green/create-physical-backup" bzip2 gzip none
