# db-runbooks — project guide

The guide every coding agent reads, whichever tool it is. `CLAUDE.md` imports this file; see *How this repository routes agent instructions* at the end.
...
procedure, worked examples, and a checklist. Read it before editing any of:
...
| Layer | File | Loaded |
|-------|------|--------|
| Always-on project guide | **`AGENTS.md`** (this file) | Directly by agents that read `AGENTS.md`; by Claude Code via the `@AGENTS.md` import in `CLAUDE.md` |
