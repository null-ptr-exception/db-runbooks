...
#
# The backup itself is produced by the `backup` (physical) path; this task only
# consumes it. The generic input validators, confirm gate, and result contract
# come from mariadb-task-common.sh (shared with the blue-green tasks).
# =============================================================================
