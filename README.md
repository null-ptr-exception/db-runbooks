...
| `status` | `:30081` (MariaDB) | Read-only operator/StatefulSet/pod/SQL status summary | `namespace`, optional `context`, `resource`, `mdb` | [docs/mariadb/status.md](docs/mariadb/status.md) |
